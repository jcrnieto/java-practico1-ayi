...
public class Constants {
     ...
     */
    public static final String SQL_SELECT_PERSON = "SELECT idpersona, nombre, apellido, edad, direccion FROM personas";
    ...
    public static final String JDBC_URL = "jdbc:mysql://localhost:3306/cursoayidb?useSSL=false&useTimezone=true&serverTimezone=UTC&allowPublicKeyRetrieval=true";
